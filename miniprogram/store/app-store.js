...
function getInventory() {
  ...
  return { ...clone(defaults.inventory), ...saved, failedBakes: { ...defaults.inventory.failedBakes, ...(saved.failedBakes || {}) } }
}
...
function getCatalog() { return storage.get(storage.KEYS.CATALOG, clone(defaults.catalog)) }
